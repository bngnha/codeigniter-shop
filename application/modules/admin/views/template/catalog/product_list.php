<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="<?php echo site_url().APPPATH?>modules/admin/views/images/product.png" alt="" /> <?php echo $heading_title; ?></h1>
...
function filter() {
	url = '<?php echo base_url();?>admin/product/req';
...
$('input[name=\'filter_name\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '<?php echo base_url();?>admin/product/autocomplete/filter_name/' +  encodeURIComponent(request.term),
			dataType: 'json',
...
$('input[name=\'filter_model\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '<?php echo base_url();?>admin/product/autocomplete/filter_model/' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
