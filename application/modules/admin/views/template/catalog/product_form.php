          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div class="scrollbox" id="product-related">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-related<?php echo $product_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_related['name']; ?><img src="<?php echo site_url().APPPATH?>modules/admin/views/images/delete.png" />
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo format_decimal($product_special['price']); ?>" /></td>
...
$('input[name=\'related\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-related').append('<div id="product-related' + ui.item.value + '">' + ui.item.label + '<img src="<?php echo site_url().APPPATH?>modules/admin/views/images/delete.png" /><input type="hidden" name="product_related[]" value="' + ui.item.value + '" /></div>');
...
function image_upload(field, thumb) {
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
				$.ajax({
					url: '<?php echo base_url();?>admin/common/filemanager/image?image=' + encodeURIComponent($('#' + field).attr('value')),
					dataType: 'text',
...
//--></script> 
<script type="text/javascript" src="<?php echo ADMIN_HTTP_RESOURCE;?>javascripts/jquery/ui/jquery-ui-timepicker-addon.js"></script> 
<script type="text/javascript"><!--
