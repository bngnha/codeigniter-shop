<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="<?php echo ADMIN_HTTP_RESOURCE;?>/images/setting.png" alt="" /> <?php echo $heading_title; ?></h1>
      <div class="buttons">
        ...
        <div id="tab-local">
          <table class="form">
            <tr>
              ...
              <td><select name="config_country_id" onchange="$('select[name=\'config_zone_id\']').load('setting/zone?country_id='+ this.value + '&zone_id=<?php echo $config_zone_id; ?>');">
...
<?php } ?>
<!--
$('#template').load('<?php echo base_url();?>admin/setting/template?template=' + encodeURIComponent($('select[name=\'config_template\']').attr('value')));
$('select[name=\'config_zone_id\']').load('<?php echo base_url();?>admin/setting/zone?country_id=<?php echo $config_country_id; ?>&zone_id=<?php echo $config_zone_id; ?>');
//-->
</script> 
<script type="text/javascript">
<!--
