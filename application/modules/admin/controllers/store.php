...
class ControllerSettingStore extends Controller {
    public function __construct()
    {
        ...
        if ($this->session->userdata('logged_in'))
        {
            ...
            // Common
            $this->data['loggedin_flg']    = $this->session->userdata('username');
            $this->data['text_logged']     = sprintf(lang('admin.banner.logged'), $this->session->userdata('username'));
            $this->data['text_system']     = lang('admin.menu.text_system');
            $this->data['text_setting']    = lang('admin.menu.text_setting');
            $this->data['text_users']      = lang('admin.menu.text_users');
            $this->data['text_usergrp']    = lang('admin.menu.text_usergrp');
            $this->data['text_logout']     = lang('admin.menu.text_logout');
            $this->data['text_frontend']   = lang('admin.menu.text_frontend');
            $this->data['text_catalog']    = lang('admin.menu.text_catalog');
            $this->data['text_category']   = lang('admin.menu.text_category');
            $this->data['text_country']     = lang('admin.menu.text_country');
            $this->data['text_language']        = lang('admin.menu.text_language');
            $this->data['text_currency']        = lang('admin.menu.text_currency');
            $this->data['text_stock_status']    = lang('admin.menu.text_stock_status');
            $this->data['text_zone']            = lang('admin.menu.text_zone');
            $this->data['text_product']         = lang('admin.menu.text_product');
