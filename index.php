...
define('HTTP_RESOURCE', HTTP_SERVER.'application/views/');
define('DIR_IMAGE', str_replace("\\", "/", realpath('uploads').'/'));
define('HTTP_IMAGE', HTTP_SERVER.'uploads/');
define('IMG_THUMB_WIDTH',100);
define('IMG_THUMB_HEIGHT',100);
define('UPLOAD_IMG_EXT','gif|jpg|png|jpeg');
define('UPLOAD_IMG_SIZE',100);
define('UPLOAD_IMG_WIDTH',1024);
define('UPLOAD_IMG_HEIGHT',768);
define('VERSION',1);
/*
 * --------------------------------------------------------------------
